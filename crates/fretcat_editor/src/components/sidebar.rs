            ...
            HStack::new(cx, |cx| {
                Binding::new(cx, Sidebar::current_tab, |cx, bind| {
                    ...
                    VStack::new(cx, |cx| {
                        ...
                        VStack::new(cx, |cx| {
                            AudioSlider::new(cx, 20.0, 200.0, ChainData::chain.map(|chain| chain.in_avg_amplitude));
                            AudioSlider::new(cx, 20.0, 200.0, ChainData::chain.map(|chain| chain.out_avg_amplitude));
                        })
